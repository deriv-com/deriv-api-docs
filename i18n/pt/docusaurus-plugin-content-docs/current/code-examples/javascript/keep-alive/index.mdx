...
<RenderOfficialContents>
  <p>Neste exemplo, verá como manter uma ligação ativa quando recebe propostas de contrato através da Deriv API. Este exemplo mantém a ligação ativa ao enviar um ping a cada 30 segundos.</p>
</RenderOfficialContents>
