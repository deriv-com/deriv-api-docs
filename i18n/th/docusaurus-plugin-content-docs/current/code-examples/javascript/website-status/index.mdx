...
keywords:
  ...
  - เว็บไซต์
  - สถานะ
description: สำรวจการตั้งค่า เช่น ขีดจำกัดการโทร ข้อมูลสกุลเงิน และภาษาที่รองรับผ่านคำขอสถานะเว็บไซต์ เรียนรู้ด้วยตัวอย่าง API นี้ เรียนรู้ด้วยตัวอย่าง API นี้
---
