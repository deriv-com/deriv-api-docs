...
<RenderOfficialContents>
  <ul>
    ...
    <li>
      <a href='category/languages'>Langages</a>
    </li>
    <li>
...
<RenderOfficialContents>
  <p>
    Consultez les pages consacrées aux <a href='/docs/category/core-concepts'>concepts fondamentaux</a> et prenez le temps de les lire (
...
<p>
  Si vous souhaitez savoir comment vous pouvez mettre en œuvre notre API dans votre code, nous vous suggérons de consulter
  nos <a href='/docs/category/code-examples'>exemples de code</a>. Ces exemples de code sont disponibles sur
...
<RenderOfficialContents>
  <h4>Mise en place d'une application Deriv</h4>
</RenderOfficialContents>
