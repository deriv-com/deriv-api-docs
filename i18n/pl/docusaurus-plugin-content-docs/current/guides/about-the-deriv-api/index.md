...
3. **Utwórz aplikację API**: Aby utworzyć aplikację API, musisz podać nazwę aplikacji i adres URL przekierowania. Adres URL przekierowania to adres URL, na który użytkownik zostanie przekierowany po autoryzacji aplikacji na dostęp do swojego konta Deriv.
